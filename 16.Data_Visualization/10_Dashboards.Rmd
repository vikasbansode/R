---
title: "VB's Dashboard"
output: 
  flexdashboard::flex_dashboard:
    orientation: rows
    vertical_layout: fill
    social: ["twitter","facebook","menu","whatsapp","google"]
    source_code: embed
---
...
data <- read.csv("D:/from E/ML/vehicle.csv")
...
veh %>%
  plot_ly(x = ~State,
          y = ~Mileage,
          type = 'violin') %>%
  layout(xaxis = list(title = "Mileage By State"),
...
**Created by : Vikas Bansode - Data Scientist**
